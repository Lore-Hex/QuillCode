...
- Computer Use status labeling for all permission combinations, deterministic stub backend action recording, shared backend factory selection, Linux Wayland/X11 helper detection, unavailable-backend preflight behavior, structured tool definitions, and executor argument validation.
