...
- GitHub Actions runs `./scripts/smoke.sh` from a clean checkout after installing E2E dependencies, including the native desktop executable render smoke.
