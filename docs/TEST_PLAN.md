...
- Patch parser, diff parser, file/line/range review comments, approval Run/Edit/Skip planning, delegated-worker approval request validation, exact held-call resume, duplicate-decision rejection, Auto reviewer JSON, reviewer-route telemetry, permission-rule telemetry preservation, redacted `scripts/safety-reviewer-calibration-smoke.sh` manifest validation, recurring `scripts/safety-reviewer-calibration-rollup.sh` calibration summary validation, and sandbox policy.
