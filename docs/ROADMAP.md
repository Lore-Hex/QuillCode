...
- Richer non-image artifact previews, plugin/skill install and execution lifecycle, richer MCP per-tool schemas/resources/prompts/streaming beyond the generic verified-server call path, autonomous memory writes/richer redaction/Chronicle jobs, memory editing, and automations.
