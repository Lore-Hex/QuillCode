...
- Rich artifact previews, plugin/skill install and execution lifecycle, MCP protocol handshake/tool routing, autonomous memory writes/richer redaction/Chronicle jobs, memory editing, and automations.
