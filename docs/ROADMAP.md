...
- Rich artifact previews, plugin/skill install and execution lifecycle, MCP server process management, autonomous memory writes/redaction/Chronicle jobs, and automations.
