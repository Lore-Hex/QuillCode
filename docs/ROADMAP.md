...
- Rich artifact previews, plugin/skill install and execution lifecycle, MCP server process management, autonomous memory writes/richer redaction/Chronicle jobs, memory editing, and automations.
