...
public struct GitToolExecutor: Sendable {
    ...
    public func createManagedWorktree(
        cwd: URL,
        path: String,
        base: String?,
        allowedRoot: URL
    ) -> ToolResult {
        worktrees.createManaged(cwd: cwd, path: path, base: base, allowedRoot: allowedRoot)
    }
    ...
    public func handoffWorktree(cwd: URL, destination: String) -> ToolResult {
