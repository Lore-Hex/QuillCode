...
struct WorkspaceCommandActionPlanner: Sendable, Hashable {
    ...
    func effect(for action: WorkspaceCommandAction) -> WorkspaceCommandActionEffect? {
        ...
        case .threadRefreshPullRequest:
            return .refreshSelectedPullRequest
        case .threadLandPullRequest:
            return .landSelectedPullRequest
        case .threadCleanupMergedWorktree:
        ...
        case .sideConversationReturn:
            // Only side conversations have a parent to return to — confidential is ephemeral too, but
