...
public enum QuillCodeMetrics {
    ...
    public static let topBarHorizontalPadding: CGFloat = 10
    public static let topBarHeight: CGFloat = 40
    public static let topBarNavigationLeadingPadding: CGFloat = 76
    public static let topBarTokenBudgetMinWidth: CGFloat = 400
    public static let topBarTokenBudgetMaxWidth: CGFloat = 520
    ...
    public static let sidebarControlSpacing: CGFloat = 4
    public static let sidebarInteractionRowHeight: CGFloat = 34
    public static let sidebarIconTargetSize: CGFloat = 34
