...
struct QuillCodeWorkspaceSheetsModifier: ViewModifier {
    ...
    var onCreateWorktreeBranch: (WorkspaceWorktreeCreateBranchRequest) -> ToolResult
    ...
    private func createWorktreeBranch() {
        let result = onCreateWorktreeBranch(createWorktreeBranchDraft.request)
        guard result.ok else {
            createWorktreeBranchDraft.errorMessage = result.error ?? result.stderr
            return
        }
        worktreeSheet = nil
    }
...
extension View {
    func quillCodeWorkspaceSheets(
        ...
        onCreateWorktreeBranch: @escaping (WorkspaceWorktreeCreateBranchRequest) -> ToolResult,
