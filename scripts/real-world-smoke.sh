...
if not isinstance(scenario_count, int) or scenario_count < 8:
    errors.append(f"scenarioCount should be at least 8, got {scenario_count!r}")
if not isinstance(prompt_count, int) or prompt_count < 17:
    errors.append(f"promptCount should be at least 17, got {prompt_count!r}")
if not isinstance(regression_guard_count, int) or regression_guard_count < 24:
    errors.append(
        f"regressionGuardCount should be at least 24, got {regression_guard_count!r}"
    )
