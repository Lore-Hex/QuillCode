...
if not isinstance(scenario_count, int) or scenario_count < 6:
    errors.append(f"scenarioCount should be at least 6, got {scenario_count!r}")
if not isinstance(prompt_count, int) or prompt_count < 15:
    errors.append(f"promptCount should be at least 15, got {prompt_count!r}")
if not isinstance(regression_guard_count, int) or regression_guard_count < 18:
    errors.append(
        f"regressionGuardCount should be at least 18, got {regression_guard_count!r}"
    )
