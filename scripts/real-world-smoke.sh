...
if not isinstance(scenario_count, int) or scenario_count < 7:
    errors.append(f"scenarioCount should be at least 7, got {scenario_count!r}")
if not isinstance(prompt_count, int) or prompt_count < 16:
    errors.append(f"promptCount should be at least 16, got {prompt_count!r}")
if not isinstance(regression_guard_count, int) or regression_guard_count < 21:
    errors.append(
        f"regressionGuardCount should be at least 21, got {regression_guard_count!r}"
    )
