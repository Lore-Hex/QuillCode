...
MAX_REPEATED_RESIDENT_MEMORY_GROWTH_BYTES="${QUILLCODE_MAX_REPEATED_RESIDENT_MEMORY_GROWTH_BYTES:-12582912}"
MAX_THREAD_COUNT="${QUILLCODE_MAX_THREAD_COUNT:-32}"
MAX_REPEATED_THREAD_GROWTH="${QUILLCODE_MAX_REPEATED_THREAD_GROWTH:-2}"
...
"$ROOT_DIR/scripts/native-click-probe-contracts.py" performance \
  ...
  --max-repeated-thread-growth "$MAX_REPEATED_THREAD_GROWTH" \
