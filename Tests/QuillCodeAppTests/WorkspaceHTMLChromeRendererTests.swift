...
final class WorkspaceHTMLChromeRendererTests: XCTestCase {
    ...
    func testHTMLRendererEscapesAndLabelsPrimaryRegions() {
        ...
        XCTAssertTrue(html.contains(#"data-testid="project-item-actions""#))
        XCTAssertTrue(html.contains(#"title="/tmp/unsafe""#))
        XCTAssertFalse(html.contains(#"data-testid="project-selection-badge""#))
    ...
    func testHTMLRendererGroupsPinnedTodayAndArchivedChats() {
        ...
        XCTAssertTrue(html.contains(#"data-testid="sidebar-filter-menu""#))
        XCTAssertTrue(html.contains(#"data-testid="sidebar-filter-menu-button""#))
        ...
        XCTAssertTrue(html.contains(#"data-testid="sidebar-activity""#))
        XCTAssertTrue(html.contains(#"data-testid="sidebar-item-actions""#))
