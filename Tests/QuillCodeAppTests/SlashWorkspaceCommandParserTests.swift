...
final class SlashWorkspaceCommandParserTests: XCTestCase {
    func testSupportsWorkspaceAliases() {
        ...
        XCTAssertTrue(SlashWorkspaceCommandParser.supports("approve"))
        XCTAssertTrue(SlashWorkspaceCommandParser.supports("approvals"))
        XCTAssertTrue(SlashWorkspaceCommandParser.supports("denials"))
