...
final class WorkspaceBrowserIntegrationTests: XCTestCase {
    ...
    func testHTMLRendererIncludesVisibleBrowserPane() throws {
        ...
        XCTAssertTrue(html.contains(#"data-testid="browser-close-tab""#))
        XCTAssertTrue(html.contains(#"data-command-id="browser-tab-new""#))
        XCTAssertTrue(html.contains(#"aria-label="New browser tab""#))
        XCTAssertTrue(html.contains(#"aria-label="Close browser tab""#))
        ...
        XCTAssertTrue(html.contains(#"type="button" class="browser-nav-button hit-target-icon" data-hit-target-kind="icon" data-hit-target-action="press" data-hit-target-source="explicit" data-testid="browser-back" aria-label="Back" disabled aria-disabled="true""#))
        XCTAssertTrue(html.contains(#"type="button" class="browser-nav-button hit-target-icon" data-hit-target-kind="icon" data-hit-target-action="press" data-hit-target-source="explicit" data-testid="browser-forward" aria-label="Forward" disabled aria-disabled="true""#))
