...
final class WorkspaceBrowserIntegrationTests: XCTestCase {
    ...
    func testHTMLRendererIncludesVisibleBrowserPane() throws {
        ...
        XCTAssertTrue(html.contains(#"type="button" class="browser-nav-button hit-target-icon" data-hit-target-kind="icon" data-testid="browser-back" aria-label="Back" disabled aria-disabled="true""#))
        XCTAssertTrue(html.contains(#"type="button" class="browser-nav-button hit-target-icon" data-hit-target-kind="icon" data-testid="browser-forward" aria-label="Forward" disabled aria-disabled="true""#))
