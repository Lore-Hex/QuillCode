...
final class AgentImmediateActionTests: XCTestCase {
    ...
    func testNegatedWhoamiDoesNotPreflight() async throws {
        let root = try makeTempDirectory()
        let runner = AgentRunner(llm: FixedSayLLMClient(message: "I will not run it."), enablesImmediateActionPreflight: true)
    ...
    func testNegatedDiagnosticDoesNotPreflight() async throws {
        let root = try makeTempDirectory()
        let runner = AgentRunner(llm: FixedSayLLMClient(message: "I will leave disk usage alone."), enablesImmediateActionPreflight: true)
    ...
    func testNegatedOpenClawDiscoveryDoesNotPreflight() async throws {
        let root = try makeTempDirectory()
        let runner = AgentRunner(llm: FixedSayLLMClient(message: "I will not inspect OpenClaw."), enablesImmediateActionPreflight: true)
    ...
    func testNegatedDownloadDoesNotPreflight() async throws {
        let root = try makeTempDirectory()
        let runner = AgentRunner(llm: FixedSayLLMClient(message: "I will not download it."), enablesImmediateActionPreflight: true)
    ...
    func testNegatedFileWriteDoesNotPreflight() async throws {
        let root = try makeTempDirectory()
        let runner = AgentRunner(llm: FixedSayLLMClient(message: "I will not create a file."), enablesImmediateActionPreflight: true)
