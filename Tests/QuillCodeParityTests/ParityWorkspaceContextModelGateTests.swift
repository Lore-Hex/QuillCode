...
final class ParityWorkspaceContextModelGateTests: QuillCodeParityTestCase {
    func testWorkspaceModelDelegatesContextResolving() throws {
        ...
        let refresherText = try Self.appSourceText(
            named: "WorkspaceProjectContextRefresher.swift"
        )
