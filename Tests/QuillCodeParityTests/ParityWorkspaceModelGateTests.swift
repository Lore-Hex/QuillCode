...
final class ParityWorkspaceModelGateTests: QuillCodeParityTestCase {
    ...
    func testWorkspaceModelDelegatesUIStateContracts() throws {
        ...
        let sendCompletionText = try Self.appSourceText(named: "WorkspaceAgentSendCompletionPlanner.swift")
        ...
        XCTAssertTrue(sendCompletionText.contains("WorkspaceComposerSendLifecycle.completed"), "Successful send completion should choose completed lifecycle through the completion planner.")
        XCTAssertTrue(modelText.contains("WorkspaceAgentSendCompletionPlanner.completed"), "WorkspaceModel should delegate composer send completion transitions.")
