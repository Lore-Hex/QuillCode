...
final class ParityBrowserGateTests: QuillCodeParityTestCase {
    func testWorkspaceModelDelegatesBrowserSurfaceTypes() throws {
        ...
        XCTAssertTrue(browserSurfaceText.contains("public struct BrowserTabState"), "Browser tab state should live in the focused browser surface file.")
        ...
        XCTAssertTrue(browserSurfaceText.contains("public struct BrowserTabSurface"), "Browser tab presentation should live in the browser surface file.")
        ...
        XCTAssertTrue(browserEngineText.contains("static func newTab"), "Browser tab creation should be a focused engine transition.")
        XCTAssertTrue(browserEngineText.contains("static func selectTab"), "Browser tab selection should be a focused engine transition.")
        XCTAssertTrue(browserEngineText.contains("static func closeTab"), "Browser tab closing should be a focused engine transition.")
        XCTAssertFalse(modelText.contains("public struct BrowserState"), "WorkspaceModel should not own browser surface state.")
        XCTAssertFalse(modelText.contains("public struct BrowserTabState"), "WorkspaceModel should not own browser tab state.")
        ...
        XCTAssertFalse(workspaceSurfaceText.contains("public struct BrowserTabSurface"), "WorkspaceSurface should not own browser tab presentation.")
