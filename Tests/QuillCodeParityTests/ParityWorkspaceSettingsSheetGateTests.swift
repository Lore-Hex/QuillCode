...
final class ParityWorkspaceSettingsSheetGateTests: QuillCodeParityTestCase {
    func testWorkspaceSwiftUIViewDelegatesSheetPresentation() throws {
        ...
        let searchText = try Self.appSourceText(named: "QuillCodeSearchView.swift")
        let shortcutText = try Self.appSourceText(named: "QuillCodeSearchAndShortcutDialogs.swift")
