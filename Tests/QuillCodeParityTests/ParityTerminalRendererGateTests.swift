...
final class ParityTerminalRendererGateTests: QuillCodeParityTestCase {
    func testTerminalRendererKeepsEscapeSemanticsInFocusedFiles() throws {
        ...
        XCTAssertTrue(rendererText.contains("\"\\u{9B}\""))
        XCTAssertTrue(rendererText.contains("\"\\u{9D}\""))
        XCTAssertTrue(rendererText.contains("\"\\u{0B}\""))
        XCTAssertTrue(rendererText.contains("\"\\u{0C}\""))
        XCTAssertTrue(rendererText.contains("\"\\u{90}\""))
        XCTAssertTrue(rendererText.contains("\"\\u{9F}\""))
