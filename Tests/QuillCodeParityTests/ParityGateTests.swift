...
final class ParityGateTests: QuillCodeParityTestCase {
    ...
    func testParityGatesUseFocusedSuitesAndSharedSupport() throws {
        ...
        XCTAssertFalse(mainLines.contains("    func testWorkspaceModelDelegatesThreadLifecycleTransitions() throws {"), "Workspace model thread gates should live in ParityWorkspaceModelGateTests.")
        XCTAssertFalse(mainLines.contains("    func testWorkspaceModelDelegatesConfigurationTransitions() throws {"), "Workspace model context/config gates should live in ParityWorkspaceModelGateTests.")
        XCTAssertFalse(mainLines.contains("    func testWorkspaceModelDelegatesContextResolving() throws {"), "Workspace model context/config gates should live in ParityWorkspaceModelGateTests.")
        XCTAssertFalse(mainLines.contains("    func testWorkspaceModelDelegatesRetryPlanning() throws {"), "Workspace model context/config gates should live in ParityWorkspaceModelGateTests.")
        XCTAssertFalse(mainLines.contains("    func testWorkspaceModelDelegatesStatusTextAndLabels() throws {"), "Workspace model context/config gates should live in ParityWorkspaceModelGateTests.")
    }
