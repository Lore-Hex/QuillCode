...
final class ParityWorkspaceProjectContextRefreshGateTests: QuillCodeParityTestCase {
    func testWorkspaceModelDelegatesProjectContextRefresh() throws {
        ...
        ].forEach { Self.assertSource(refresherText, contains: $0) }
        [
        ...
        Self.assertSource(contextPreparerText, contains: "WorkspaceProjectContextRefresher.syncThreadContext")
        Self.assertSource(composerText, contains: "WorkspaceThreadContextPreparer.syncThreadContext")
        Self.assertSource(threadExtensionText, contains: "WorkspaceProjectContextRefresher.threadCreationContext")
        Self.assertSource(worktreeExtensionText, contains: "WorkspaceProjectContextRefresher.worktreeOpenContext")
        [
        ...
        Self.assertSource(composerText, excludes: "WorkspaceProjectContextRefresher.syncThreadContext")
    }
}
