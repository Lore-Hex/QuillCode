...
final class ParityWorkspacePlaywrightAutomationGateTests: QuillCodeParityTestCase {
    func testPlaywrightAutomationFlowsStayInFocusedSpec() throws {
        ...
        Self.assertSource(automationSpecText, containsAll: automationFlowNames)
        Self.assertSource(coreSpecText, excludesAll: automationFlowNames)
    }
}
