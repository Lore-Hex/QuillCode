...
final class ParitySmokeScriptGateTests: QuillCodeParityTestCase {
    ...
    func testPackagedMacOSSmokeComparesDirectAndLaunchServicesClickProbes() throws {
        ...
        XCTAssertTrue(script.contains("\"accessibilityFrameSamples\""))
        XCTAssertTrue(script.contains("\"liveAccessibilitySampling\""))
        XCTAssertTrue(script.contains("\"frame-sampled\""))
        XCTAssertTrue(script.contains("\"unresolvedRequiredContractIDs\""))
        XCTAssertTrue(script.contains("\"sampleCount\""))
