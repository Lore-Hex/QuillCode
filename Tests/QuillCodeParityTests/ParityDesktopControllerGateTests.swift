...
final class ParityDesktopControllerGateTests: QuillCodeParityTestCase {
    ...
    func testDesktopControllerDelegatesSettingsPersistenceAndSystemSettings() throws {
        ...
        Self.assertSource(controllerText, excludes: "model.setComputerUseForegroundApplication")
    ...
    func testDesktopControllerDelegatesProjectImportResolution() throws {
        ...
        let accessText = try Self.desktopSourceText(named: "QuillCodeDesktopProjectAccessCoordinator.swift")
        ...
        Self.assertSource(controllerText, contains: "projectAccessCoordinator.retainAccess")
        Self.assertSource(controllerText, contains: "projectAccessCoordinator.restoreAccess")
        Self.assertSource(accessText, contains: "startAccessingSecurityScopedResource")
        Self.assertSource(accessText, contains: "bookmarkData(")
        Self.assertSource(accessText, contains: "reconcileProjects")
