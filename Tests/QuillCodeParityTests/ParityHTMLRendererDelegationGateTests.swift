...
final class ParityHTMLRendererDelegationGateTests: QuillCodeParityTestCase {
    ...
    func testWorkspaceHTMLRendererDelegatesSecondaryPaneRendering() throws {
        ...
        XCTAssertTrue(secondaryText.contains("enum WorkspaceHTMLSecondaryPaneRenderer"), "HTML secondary panes should keep a stable facade.")
        XCTAssertTrue(secondaryText.contains("static func renderExtensions"), "Extensions HTML should keep a stable entry point.")
        XCTAssertTrue(secondaryText.contains("static func renderMemories"), "Memories HTML should keep a stable entry point.")
        XCTAssertTrue(secondaryText.contains("static func renderActivity"), "Activity HTML should keep a stable entry point.")
        XCTAssertTrue(secondaryText.contains("static func renderAutomations"), "Automation HTML should keep a stable entry point.")
        XCTAssertTrue(secondaryText.contains("WorkspaceHTMLExtensionsPaneRenderer.render"), "Extensions HTML should delegate to a focused renderer.")
        XCTAssertTrue(secondaryText.contains("WorkspaceHTMLMemoriesPaneRenderer.render"), "Memories HTML should delegate to a focused renderer.")
        XCTAssertTrue(secondaryText.contains("WorkspaceHTMLActivityPaneRenderer.render"), "Activity HTML should delegate to a focused renderer.")
        XCTAssertTrue(secondaryText.contains("WorkspaceHTMLAutomationsPaneRenderer.render"), "Automations HTML should delegate to a focused renderer.")
        XCTAssertTrue(extensionsText.contains("enum WorkspaceHTMLExtensionsPaneRenderer"), "Extensions pane HTML should live in its own renderer.")
        XCTAssertTrue(memoriesText.contains("enum WorkspaceHTMLMemoriesPaneRenderer"), "Memories pane HTML should live in its own renderer.")
        XCTAssertTrue(activityText.contains("enum WorkspaceHTMLActivityPaneRenderer"), "Activity pane HTML should live in its own renderer.")
        XCTAssertTrue(automationsText.contains("enum WorkspaceHTMLAutomationsPaneRenderer"), "Automation pane HTML should live in its own renderer.")
        XCTAssertTrue(extensionsText.contains("private static func renderMCPTools"), "MCP tool chips should live beside Extensions HTML.")
        XCTAssertTrue(automationsText.contains("private static func renderAutomationActions"), "Automation actions should live beside Automations HTML.")
        XCTAssertTrue(primitivesText.contains("WorkspaceHTMLPrimitives.escape"), "Secondary pane renderers should reuse shared HTML escaping.")
        XCTAssertTrue(primitivesText.contains("static func countLabel"), "Secondary pane pluralization should stay shared.")
        ...
        XCTAssertFalse(secondaryText.contains("private static func renderMCPTools"), "Secondary pane facade should not own Extensions details.")
        XCTAssertFalse(secondaryText.contains("private static func renderAutomationActions"), "Secondary pane facade should not own Automation details.")
        XCTAssertFalse(secondaryText.contains("private static func countLabel"), "Secondary pane facade should not own shared pluralization.")
    ...
    func testWorkspaceHTMLRendererDelegatesSidebarRendering() throws {
        ...
        let sidebarCommandText = try Self.appSourceText(named: "WorkspaceHTMLSidebarCommandRenderer.swift")
        let sidebarProjectText = try Self.appSourceText(named: "WorkspaceHTMLSidebarProjectRenderer.swift")
        let sidebarSavedSearchText = try Self.appSourceText(named: "WorkspaceHTMLSidebarSavedSearchRenderer.swift")
        let sidebarThreadText = try Self.appSourceText(named: "WorkspaceHTMLSidebarThreadRenderer.swift")
        ...
        XCTAssertTrue(sidebarText.contains("WorkspaceHTMLSidebarCommandRenderer.renderPrimaryActions"), "Sidebar facade should delegate primary command rendering.")
        XCTAssertTrue(sidebarText.contains("WorkspaceHTMLSidebarThreadRenderer.render"), "Sidebar facade should delegate thread rendering.")
        XCTAssertTrue(sidebarText.contains("WorkspaceHTMLSidebarProjectRenderer.render"), "Sidebar facade should delegate project rendering.")
        XCTAssertTrue(sidebarText.contains("WorkspaceHTMLSidebarCommandRenderer.renderFooter"), "Sidebar facade should delegate footer command rendering.")
        XCTAssertTrue(sidebarProjectText.contains("enum WorkspaceHTMLSidebarProjectRenderer"), "Project-list HTML should live in a focused sidebar renderer.")
        XCTAssertTrue(sidebarProjectText.contains("private static func renderProjects"), "Project-list rendering should live beside project sidebar HTML.")
        XCTAssertTrue(sidebarProjectText.contains("project-empty"), "Project empty-state markup should live beside project sidebar HTML.")
        XCTAssertTrue(sidebarProjectText.contains("WorkspaceHTMLPrimitives.escape"), "Project sidebar renderer should reuse shared HTML escaping.")
        XCTAssertTrue(sidebarThreadText.contains("enum WorkspaceHTMLSidebarThreadRenderer"), "Thread-list HTML should live in a focused sidebar renderer.")
        XCTAssertTrue(sidebarThreadText.contains("private static func renderThreadSections"), "Thread-section rendering should live beside thread sidebar HTML.")
        XCTAssertTrue(sidebarThreadText.contains("private static func renderBulkToolbar"), "Bulk-selection rendering should live beside thread sidebar HTML.")
        XCTAssertTrue(sidebarThreadText.contains("private static func renderSelectionHeaderAction"), "Selection affordance rendering should stay with thread sidebar HTML.")
        XCTAssertTrue(sidebarThreadText.contains("sidebar-empty"), "Thread empty-state markup should live beside thread sidebar HTML.")
        XCTAssertTrue(sidebarThreadText.contains("WorkspaceHTMLPrimitives.escape"), "Thread sidebar renderer should reuse shared HTML escaping.")
        XCTAssertTrue(sidebarSavedSearchText.contains("enum WorkspaceHTMLSidebarSavedSearchRenderer"), "Saved-search HTML should live in a focused sidebar renderer.")
        XCTAssertTrue(sidebarSavedSearchText.contains("sidebar-saved-search-row"), "Saved-search row markup should live beside saved-search sidebar HTML.")
        XCTAssertTrue(sidebarSavedSearchText.contains("sidebar-saved-search-create"), "Saved-search create markup should live beside saved-search sidebar HTML.")
        XCTAssertTrue(sidebarSavedSearchText.contains("private static func renderMoveButton"), "Saved-search move buttons should live beside saved-search sidebar HTML.")
        XCTAssertTrue(sidebarCommandText.contains("enum WorkspaceHTMLSidebarCommandRenderer"), "Sidebar command HTML should live in a focused renderer.")
        XCTAssertTrue(sidebarCommandText.contains("static func renderFooter"), "Sidebar tool footer rendering should live beside command sidebar HTML.")
        XCTAssertTrue(sidebarCommandText.contains("private static func renderUtilityAction"), "Individual utility command HTML should live beside grouped command rendering.")
        XCTAssertTrue(sidebarCommandText.contains("sidebar-tools-popover"), "Sidebar footer markup should live beside command sidebar HTML.")
        XCTAssertTrue(sidebarCommandText.contains("WorkspaceHTMLPrimitives.escape"), "Sidebar command renderer should reuse shared HTML escaping.")
        ...
        XCTAssertFalse(sidebarText.contains("private static func renderProjects"), "Sidebar facade should not own project-list rendering.")
        XCTAssertFalse(sidebarText.contains("private static func renderThreadSections"), "Sidebar facade should not own thread-section rendering.")
        XCTAssertFalse(sidebarText.contains("private static func renderBulkToolbar"), "Sidebar facade should not own bulk-selection rendering.")
        XCTAssertFalse(sidebarText.contains("private static func renderFooter"), "Sidebar facade should not own footer rendering.")
        XCTAssertFalse(sidebarText.contains("private static func renderUtilityAction"), "Sidebar facade should not own individual utility command HTML.")
        XCTAssertFalse(sidebarText.contains("sidebar-tools-popover"), "Sidebar facade should not own sidebar footer markup.")
        XCTAssertFalse(sidebarText.contains("project-empty"), "Sidebar facade should not own project empty-state markup.")
