...
final class ParityWorkspaceThreadMutationModelGateTests: QuillCodeParityTestCase {
    func testWorkspaceModelDelegatesThreadNoticeMutation() throws {
        ...
        Self.assertSource(mutationText, contains: "WorkspaceThreadNoticeAppender.appendNotice")
        Self.assertSource(reviewText, contains: "WorkspaceThreadNoticeAppender.appendAssistantNotice")
    ...
    func testWorkspaceModelUsesExplicitAgentRunThreadUpdates() throws {
        ...
        Self.assertSource(mutationText, contains: "func updateThreadFromAgentRun")
