...
final class ParityWorkspaceSidebarGateTests: QuillCodeParityTestCase {
    func testWorkspaceModelDelegatesSidebarSelectionTransitions() throws {
        ...
        XCTAssertTrue(sidebarModelText.contains("WorkspaceSidebarSelectionEngine.start"), "WorkspaceModel sidebar extension should delegate selection start.")
        XCTAssertTrue(sidebarModelText.contains("WorkspaceSidebarSelectionEngine.selectAll"), "WorkspaceModel sidebar extension should delegate select-all.")
        XCTAssertTrue(sidebarModelText.contains("WorkspaceSidebarSelectionEngine.toggle"), "WorkspaceModel sidebar extension should delegate selection toggles.")
        XCTAssertTrue(sidebarModelText.contains("setSidebarFilter"), "WorkspaceModel sidebar extension should own the saved-filter transition API.")
        XCTAssertTrue(sidebarModelText.contains("clearSidebarSelection()"), "Changing saved filters should clear hidden bulk selections.")
        ...
        XCTAssertTrue(sidebarModelText.contains("WorkspaceSidebarBulkActionPlanner.plan"), "WorkspaceModel sidebar extension should delegate bulk action target planning.")
        ...
        XCTAssertTrue(sidebarModelText.contains("WorkspaceSidebarBulkActionExecutor.execute"), "WorkspaceModel sidebar extension should delegate bulk action execution.")
        XCTAssertFalse(threadExtensionText.contains("public func startSidebarSelection"), "Thread lifecycle extension should not own sidebar-selection API bodies.")
        XCTAssertFalse(threadExtensionText.contains("public func performSidebarBulkAction"), "Thread lifecycle extension should not own sidebar bulk-action API bodies.")
        XCTAssertFalse(threadExtensionText.contains("setSidebarFilter"), "Thread lifecycle extension should not own saved-filter transition API.")
    ...
    func testSidebarCommandPresentationIsSharedByNativeAndHTMLSurfaces() throws {
        ...
        let htmlSidebarCommandText = try Self.appSourceText(named: "WorkspaceHTMLSidebarCommandRenderer.swift")
        ...
        XCTAssertTrue(htmlSidebarText.contains("WorkspaceHTMLSidebarCommandRenderer.renderPrimaryActions"), "HTML sidebar facade should delegate primary sidebar actions.")
        XCTAssertTrue(htmlSidebarText.contains("WorkspaceHTMLSidebarCommandRenderer.renderFooter"), "HTML sidebar facade should delegate utility menu actions.")
        XCTAssertTrue(htmlSidebarCommandText.contains("renderPrimaryActions"), "HTML sidebar command renderer should build primary sidebar actions through a helper.")
        XCTAssertTrue(htmlSidebarCommandText.contains("renderUtilityActions"), "HTML sidebar command renderer should build utility menu actions through a helper.")
        XCTAssertTrue(htmlSidebarCommandText.contains("QuillCodeSidebarCommandPresentation.primaryCommandIDs"), "HTML sidebar command renderer should consume shared primary command ordering.")
        XCTAssertTrue(htmlSidebarCommandText.contains("QuillCodeSidebarCommandPresentation.visibleUtilityCommandGroups"), "HTML sidebar command renderer should consume shared utility command groups.")
        XCTAssertTrue(htmlSidebarCommandText.contains("QuillCodeSidebarCommandPresentation.htmlIconToken"), "HTML sidebar command renderer should consume shared icon tokens.")
        ...
        XCTAssertFalse(htmlSidebarText.contains(#"data-icon="plugins">Plugins"#), "HTML sidebar facade should not hard-code sidebar plugin markup.")
        XCTAssertFalse(htmlSidebarCommandText.contains(#"data-icon="plugins">Plugins"#), "HTML sidebar command renderer should not hard-code sidebar plugin markup.")
    }
    ...
    func testWorkspaceSurfaceDelegatesSidebarSurfaceContracts() throws {
        ...
        XCTAssertTrue(sidebarItemText.contains("public struct SidebarItemSurface"), "Thread sidebar item rows should live in focused item contracts.")
        XCTAssertTrue(sidebarItemText.contains("public enum SidebarBulkActionKind"), "Thread bulk action labels should live in focused item contracts.")
        XCTAssertTrue(sidebarItemText.contains("public struct SidebarBulkActionSurface"), "Thread bulk action command IDs should live in focused item contracts.")
        XCTAssertTrue(sidebarItemText.contains("public enum SidebarItemActionKind"), "Thread action labels should live in focused item contracts.")
        XCTAssertTrue(sidebarItemText.contains("public struct SidebarItemActionSurface"), "Thread action records should live in focused item contracts.")
        XCTAssertTrue(sidebarFilterText.contains("public enum SidebarSavedFilterKind"), "Thread saved filters should live in focused filter contracts.")
        XCTAssertTrue(sidebarFilterText.contains("public struct SidebarSavedSearchSurface"), "Thread saved searches should live in focused filter contracts.")
        ...
        XCTAssertFalse(sidebarItemText.contains("public struct SidebarSurface"), "Thread item contracts should not own aggregate sidebar records.")
        XCTAssertFalse(sidebarFilterText.contains("public struct SidebarSurface"), "Thread filter contracts should not own aggregate sidebar records.")
