...
final class ParityPackagedMacOSSmokeGateTests: QuillCodeParityTestCase {
    func testPackagedMacOSSmokeIncludesLiveWindowProof() throws {
        ...
        XCTAssertTrue(supportText.contains(#""workspaceWindowCount": workspaceWindowCount"#))
        XCTAssertTrue(supportText.contains(#""memoryPressure": memoryPressure.dictionary"#))
        ...
        XCTAssertTrue(windowSmokeText.contains("visibleWorkspaceWindows.count"))
        XCTAssertTrue(windowSmokeText.contains("NSApplication.shared.windows.first(where: isSmokeWindow)"))
        ...
        XCTAssertTrue(windowSmokeText.contains("memoryPressureController.handle(.critical)"))
        XCTAssertTrue(windowSmokeText.contains("selectedThreadPreserved"))
        XCTAssertTrue(windowSmokeText.contains("composerDraftPreserved"))
        ...
        XCTAssertTrue(clickProbeValidator.contains(#"report.get("workspaceWindowCount") == 1"#))
        XCTAssertTrue(clickProbeValidator.contains(#"_validate_memory_pressure(report, report_path)"#))
