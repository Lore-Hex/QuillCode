...
final class ParityAgentGateTests: QuillCodeParityTestCase {
    func testAgentRunnerDelegatesFinalAnswerFormatting() throws {
        ...
        XCTAssertTrue(formatterText.contains("ToolDefinition.shellRun.name"), "Shell final-answer special cases should live with tool formatters.")
        XCTAssertTrue(formatterText.contains("ToolDefinition.browserInspect.name"), "Browser final-answer special cases should live with tool formatters.")
