...
final class ParityDesktopBrowserAdapterGateTests: QuillCodeParityTestCase {
    ...
    func testDesktopBrowserVisibleSessionUsesFocusedAdapter() throws {
        ...
        let sessionJavaScriptText = try Self.desktopSourceText(named: "DesktopBrowserSessionJavaScript.swift")
        ...
        Self.assertSource(presenterContractsText, contains: "protocol DesktopBrowserSessionPresenting")
        Self.assertSource(sessionWindowText, contains: "WKWebView")
        Self.assertSource(sessionWindowText, contains: "configuration.websiteDataStore = .default()")
        Self.assertSource(sessionWindowText, contains: "loadFileURL")
        ...
        Self.assertSource(sessionJavaScriptText, contains: "JSONEncoder().encode(value)")
        Self.assertSource(sessionWindowText, contains: "DesktopBrowserLiveDOMSnapshotExtractor.snapshot")
        Self.assertSource(sessionWindowText, contains: "tab.webView.reload()")
        Self.assertSource(sessionWindowText, contains: "sync(snapshot)")
        Self.assertSource(sessionWindowText, contains: "emitRenderedSessionUpdate")
        Self.assertSource(sessionWindowText, contains: "liveDOMSnapshot: liveDOMSnapshots[id]")
        Self.assertSource(extractorText, contains: "DesktopBrowserLiveDOMSnapshotExtractor")
        Self.assertSource(sessionWindowText, contains: "NSTabView")
        Self.assertSource(sessionWindowText, contains: "func present()")
