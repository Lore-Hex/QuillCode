...
final class ParityWorkspaceModelThreadGateTests: QuillCodeParityTestCase {
    ...
    func testWorkspaceModelDelegatesThreadSeedBuilding() throws {
        ...
        XCTAssertTrue(summaryPromptText.contains("enum WorkspaceContextSummaryPromptBuilder"), "Context-summary prompt shaping should live outside generator orchestration.")
        XCTAssertTrue(summarySanitizerText.contains("enum WorkspaceContextSummarySanitizer"), "Context-summary redaction and truncation should live outside generator orchestration.")
        XCTAssertTrue(summaryRequestText.contains("struct WorkspaceContextSummaryRequest"), "Context-summary request DTOs should have a focused model file.")
        XCTAssertTrue(summaryTelemetryText.contains("struct WorkspaceContextSummaryTelemetry"), "Context-summary telemetry DTOs should have a focused model file.")
